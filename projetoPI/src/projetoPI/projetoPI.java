...
public class projetoPI {
	...
	public static int question1(int health) throws InterruptedException {
		...
		// Estrutura de randomificar qual questão será escolhida entre três.
	...
	public static int question4(int health, int maxDodge, String itemGained) throws InterruptedException {
		...
		if (maxDodge >= hit) {
			...
			if (a == 0) {
				...
				// Alein é acertado pelo Ghoul.

			} else {

				health = 20;

				write("Narrador: Aelin pensa ter completado o encatamento, mas algo deu errado e ele até consegue lançar fogo no inimigo e elimina-lo, "
						+ "mas perde o controle das chamas e toma " + health + " de dano\n", TimeUnit.MILLISECONDS,
						timer);
				...
				if (a == 0) {
					...
					case "A":
						...
						if (correct1.equals(Quest1[urn.get(Count[0])])) {
							...
							write("Narrador: Aelin pensa ter completado o encatamento, mas algo deu errado e ele até consegue lançar fogo no \n"
									+ "inimigo e elimina-lo, mas perde o controle das chamas e toma /n" + 5
									+ " de dano\n", TimeUnit.MILLISECONDS, timer);
	...
	public static int question5(int health) throws InterruptedException {
	...
	public static int question6(int health) throws InterruptedException {
	...
	public static int question7(int health) throws InterruptedException {
	...
	public static int question8(int health) throws InterruptedException {
	...
	public static int question9(int health) throws InterruptedException {
	...
	// Pegando número para utilizar no momento de receber o item do Tio.
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// Parâmetros de retorno das funções, também compoem os cálculos de retorno.

		int health = 0, defense = 0, attack = 0, dodge = 0, addHealth = 0;

		do {

			write("The Legend of Lyuba...\n", TimeUnit.MILLISECONDS, timer);
			...
			case 2:
				...
				write("\nEm um tempo antigo, cheio de violência e misticismo, os grandes magos de Winterhold após dezenas de milhares de anos \n"
				...
				write("Narrador: Enquanto Galandriel se retira, Aelin se levanta e segue para fazer suas necessidades matinais. Após termina-lôs, pega o seu \n"
						...
						+ "palavas em élfico antigo: (Lembre-se que enquando o Aelin estiver conjurando, será necessário que as questões matemáticas sejam \n"
