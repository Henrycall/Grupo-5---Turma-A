...
public class projetoPI {
	...
	public static int question10(int health, String itemGained) throws InterruptedException {
		...
		do {
			...
			case 1:
				...
				write("\nO jogo � baseado em RPG de mesa, o mestre da mesa que chamamos de narrador \n"
						+ "ir� guiar a gameplay e de certa maneira controlar o mundo ao redor de Aelin, vo�� deve \n"
			...
			case 2:
				...
				write("\nEm um tempo antigo, cheio de viol�ncia e misticismo, os grandes magos de Winterhold ap�s dezenas de milhares de anos \n"
				...
				write("\nNarrador: O dia est� amanhecendo, uma pequena n�voa surge por entre as �rvores cobrindo a �rea de floresta em volta da casa \n"
						...
						+ "para garantir que consiga uma vaga entre os grandes magos de Winterhold e poss�velmente, ser guardi�o do reino. O Silencio \n"
				...
				write("Narrador: Ao abrir os olhos, Aelin se depara com Galandriel olhando ele da entrada de seu quarto, um lugar com uma luminosidade \n"
						...
						+ "ele subtraiu muito tempo de sua vida folheando. O local est� um pouco bagun�ado com pratos, canecas sujas e folhas de pergaminhos \n"
				...
				write("Galandriel: � o m�ximo que posso fazer por voc�, sabe bem que eu n�o posso interferir em mais nada em rela��o ao seu treino, ou voc� \n"
				...
				write("Narrador: Enquanto Galandriel se retira, Aelin se levanta e segue para fazer suas necessidades matinais. Ap�s termina-l�s, pega o seu \n"
						...
						+ "palavas em �lfico antigo: (Lembre-se que enquando o Aelin estiver conjurando, ser� necess�rio que as quest�es matem�ticas sejam \n"
				...
				write("\nNarrador: Assim foi o incidente com a Princesa que virou conto dentre os habitantes de Odessa, da coragem e determina��o de um simples "
						+ "jovem mago que queria seguir os passos do pai e se tornar o �Guardi�o� do Reino.",
						TimeUnit.MILLISECONDS, timer);
