...
public class projetoPI {
		...
		if (a == 0) {
			...
			case "A":
				...
				if (correct1.equals(Quest1[urn.get(Count[0])])) {
					...
					write("Narrador: Enquanto a equações magicas são proferidas, um vento forte se forma ao redor de Aelin, se tornando em chamas\n"
							+ " que rodeiam-o sendo canalizadas para suas mãos e quando ele traz a resolusão a tona, o feitiso termina com ele lansando\n"
							+ " uma enorme bola de fogo em diresão ao alvo que esta em sua frente. \n",
							TimeUnit.MILLISECONDS, timer);

				} else {

					write("Narrador: Enquanto a equaçõess magicas são proferidas, um vento forte se forma ao redor de Aelin, se tornando em chamas que \n"
							+ "rodeiam-o sendo canalizadas para suas mãos e quando ele traz a resolusão a tona, algo de errado faz com que Aelin perca \n"
							+ "o controle das chamas, causando uma explosão e causando dano em si mesmo.\n",
							TimeUnit.MILLISECONDS, timer);
			...
			case "A":
				...
				if (correct2.equals(Quest2[urn.get(Count[0])])) {
					...
					write("Narrador: Enquanto as equaçoes magicas são proferidas, um vento forte se forma ao redor de Aelin, se tornando em chamas\n"
							+ " que rodeiam-o sendo canalizadas para suas mãos e quando ele traz a resolução a tona, o feitiço termina com ele lansando\n"
							+ " uma enorme bola de fogo em diresão ao alvo que estão em sua frente. \n",
							TimeUnit.MILLISECONDS, timer);

				} else {

					write("Narrador: Enquanto a equações magicas são proferidas, um vento forte se forma ao redor de Aelin, se tornando em chamas que \n"
							+ "rodeiam-o sendo canalizadas para suas mãos e quando ele traz a resoluções a tona, algo de errado faz com que Aelin perca \n"
							+ "o controle das chamas, causando uma explosão e causando dano em si mesmo.\n",
							TimeUnit.MILLISECONDS, timer);
			...
			case "A":
				...
				if (correct3.equals(Quest3[urn.get(Count[0])])) {
					...
					write("Narrador: Enquanto a equaçoes magicas são proferidas, um vento forte se forma ao redor de Aelin, se tornando em chamas\n"
							+ " que rodeiam-o sendo canalizadas para suas mãos e quando ele traz a resolusão a tona, o feitiço termina com ele lançando\n"
							+ " uma enorme bola de fogo em diresão ao alvo que esta em sua frente. \n",
							TimeUnit.MILLISECONDS, timer);
				} else {
		...
		if (a == 0) {
			...
			case "A":
				...
				if (correct1.equals(Quest1[urn.get(Count[0])])) {
					...
					write("\nNarrador: Enquanto a equações magicas são proferidas, um vento forte se forma ao redor de Aelin, uma aura gelada se forma \n"
							+ "ao seu redor, centralizando a baixa temperatura no centro de suas mãos. Após o terrmino da conjuração Aelin aponta em \n"
							+ "direção ao alvo que são congelado instantaneamente.\n", TimeUnit.MILLISECONDS, timer);

				} else {

					health = 5;

					write("\nNarrador: Enquanto a equações magicas são proferidas, um vento forte se forma ao redor de Aelin, uma aura gelada se forma ao \n"
							+ "seu redor, centralizando a baixa temperatura no centro de suas mãos. É possivel ver que as onde de frio intenso vão em direção \n"
							+ "as mãos do Aelin, porem algo da errado e o frio se expande causando uma explosão proxima demais de Aelin causando\n"
							+ health + "dano. \n", TimeUnit.MILLISECONDS, timer);
			...
			System.out.println("Aelin: Quais das expressÃµes a baixo são equivalentes a 5Â²/5^8: \n");
			...
			case "A":
				...
				if (correct2.equals(Quest2[urn.get(Count[0])])) {
					...
					write("\nNarrador: Enquanto a equações magicas são proferidas, um vento forte se forma ao redor de Aelin, uma aura gelada se forma \n"
							+ "ao seu redor, centralizando a baixa temperatura no centro de suas mãos. Após o terrmino da conjuração Aelin aponta em \n"
							+ "direção ao alvo que  congelado instantaneamente.\n", TimeUnit.MILLISECONDS, timer);

				} else {

					health = 5;

					write("\nNarrador: Enquanto a equações magicas sãoo proferidas, um vento forte se forma ao redor de Aelin, uma aura gelada se forma ao \n"
							+ "seu redor, centralizando a baixa temperatura no centro de suas mãos.É possivel que as onde de frio intenso vão em direção \n"
							+ "as mãos do Aelin, porem algo da errado e o frio se expande causando uma explosão proxima demais de Aelin causando\n"
							+ health + "dano. \n", TimeUnit.MILLISECONDS, timer);
			...
			case "A":
				...
				if (correct3.equals(Quest3[urn.get(Count[0])])) {
					...
					write("\nNarrador: Enquanto a equações magicas são proferidas, um vento forte se forma ao redor de Aelin, uma aura gelada se forma \n"
							+ "ao seu redor, centralizando a baixa temperatura no centro de suas mãos. Após o termino da conjuração Aelin aponta em \n"
					...
					write("\nNarrador: Enquanto a equações magicas são proferidas, um vento forte se forma ao redor de Aelin, uma aura gelada se forma ao "
							+ "seu redor, centralizando a baixa temperatura no centro de suas mãoos. É possivel ver que as onde de frio intenso vão em direção "
							+ "as mãos do Aelin, porem algo da errado e o frio se expande causando uma explosão proxima demais de Aelin causando"
							+ health + "dano. \n", TimeUnit.MILLISECONDS, timer);
	...
	public static int question3(int health) throws InterruptedException {
		...
		if (a == 0) {
			...
			System.out.println("\nAelin: Escolha a equação que resultara em uma reta crescente\n");
			...
			case "A":
				...
				if (correct1.equals(Quest1[urn.get(Count[0])])) {
					...
					write("\nNarrador: Enquanto Aelin começa a reproduzir as palavras do feitiço,É possivel vizualizar uma aura de mana envolvendo-o \n"
							+ "e é posssivel ver aos poucos ele ficando transparente, após a finalização Aelin ficou invisivel e consegue escapar \n"
					...
					write("\nNarrador: Enquanto Aelin começa a reproduzir as palavras do feitiço, é possivel vizualizar uma aura de mana envolvendo-o \n"
							+ "e é possivel ver aos poucos ele ficando transparente, mas Aelin pula uma palavra do feitiço e causa uma enorme explosão, \n"
			...
			System.out.println(
					"\nAelin:  Os computadores utilizam o sistema binÃ¡rio ou de base 2 que é um sistema de numeração em que todas as quantidades se "
			...
			case "A":
				...
				if (correct2.equals(Quest2[urn.get(Count[0])])) {
					...
					write("\nNarrador: Enquanto Aelin come a reproduzir as palavras do feitiço, é possivel vizualizar uma aura de mana envolvendo-o \n"
							+ "e é possivel ver aos poucos ele ficando transparente, após a finalização Aelin ficou invisivel e consegue escapar \n"
							+ "enquanto os inimigos não conseguem identificar a sua presença.\n", TimeUnit.MILLISECONDS,
							timer);
			...
			System.out.println(
					"\nAelin:  abe-se que o presãoo a ser pago por uma corrida de taxi inclui uma parcela fixa, que é denominada bandeirada, "
							+ "e uma parcela variavel, que é função da distancia percorrida. Se o preço da bandeirada é R$4,60 e o quilometro é rodado "
			...
			case "A":
				...
				if (correct3.equals(Quest3[urn.get(Count[0])])) {
					...
					write("\nNarrador: Enquanto Aelin começa a reproduzir as palavras do feitiço, é possivel vizualizar uma aura de mana envolvendo-o \n"
							+ "e é possÃ­vel ver aos poucos ele ficando transparente, após a finalização Aelin ficou invisivel e consegue escapar \n"
							+ "enquanto os inimigos não conseguem identificar a sua presença.\n", TimeUnit.MILLISECONDS,
							timer);
	...
	public static int question4(int health, int maxDodge, String itemGained) throws InterruptedException {
		...
		// Estrutura de decisÃƒÂ£o para validar o ataque.
		if (maxDodge >= hit) {

			write("\nNarrador: Aelin é um elfo, eles são conhecidos por sua agilidade e precisão, o Ghoul não tem chances contra uma \n"
					+ "movimentação tão precisa, e Aelin tomando distÃ¢ncia inicia a conjuração de um feitiço de ataque para acabar \n"
					+ "com a batalha.\n", TimeUnit.MILLISECONDS, timer);

			if (a == 0) {

				System.out.println("\nAelin: Qual expressão exponencial é equivalente a rais 7Âº de B\n");
				...
				case "A":
					...
					if (correct1.equals(Quest1[urn.get(Count[0])])) {
						...
						write("\nNarrador: Aelin completa o encantamento e tudo oque se vão são chamas e uma enorme bola de fogo vai em direção \n"
				...
				case "A":
					...
					if (correct2.equals(Quest2[urn.get(Count[0])])) {
						...
						write("\nNarrador: Aelin completa o encantamento e tudo oque se ve são chamas e uma enorme bola de fogo vai em direção \n"
								+ "ao Ghoul que é completamente derretido por tamanho calor.\n", TimeUnit.MILLISECONDS,
								timer);
			...
			if (a == 0) {
				...
				System.out.println("\nAelin: Qual o resultado da divisÃ£o de:  2x^3 + 4x^2 - 6x+4 por x - 3\n");
	...
	public static int question5(int health, String itemGained) throws InterruptedException {
		...
		if (a == 0) {
			...
			System.out.println("Aelin: Qual dos resultados a seguir Ã© soluÃ§Ã£o da potÃªncia 10^6");
			...
			case "A":
				...
				if (correct1.equals(Quest1[urn.get(Count[0])])) {
					...
					write("Aelin sopra uma espÃ©cie de fumaÃ§a, quase invisÃ­vel e "
							+ "consegue enganhar os guardas, depois passa facilmente por eles. "
							+ "de fogo vai em direÃƒÂ§ÃƒÂ£o ao Ghoul que ÃƒÂ© completamente derretido por tamanho calor.\n",
							TimeUnit.MILLISECONDS, timer);
					...
					write("Narrador: Aelin sopra uma espÃ©cie de fumaÃ§a, quase invisÃ­vel mas nada acontece e nÃ£o resta nada AlÃ©m de esperar uma brecha"
							+ " dos seguranÃ§as para entrar. ApÃ³s aguardar cerca de 1 hora, Aelin"
			...
			System.out.println(
					"- Aelin: A respeito das propriedades de potÃªncias, qual das seguintes alternativas estÃ¡ correta?");

			String Quest2[] = {
					"No produto entre duas potÃªncias de mesmo expoente, conserva-se a base e somam-se os expoentes.",
					" Na divisÃ£o entre duas potÃªncias de mesmo expoente, conserva-se a base e subtraem-se os expoentes",
					"Em uma potÃªncia de expoente negativo, inverte-se a base e troca-se o sinal do expoente.",
					"Em uma potÃªncia de potÃªncia, conserva-se a base e somam-se os expoentes.",
					"Nenhuma das alternativas" };
			int Count[] = { 0, 1, 2, 3, 4 };
			String correct2 = "Em uma potÃªncia de expoente negativo, inverte-se a base e troca-se o sinal do expoente.",
					answer2 = "";
			...
			case "B":
				...
				if (correct2.equals(Quest2[urn.get(Count[1])])) {
					...
					write("Aelin sopra uma espÃ©cie de fumaÃ§a, quase invisÃ­vel e "
							+ "consegue enganhar os guardas, depois passa facilmente por eles. "
							+ "de fogo vai em direÃ§Ã£o ao Ghoul que ÃƒÂ© completamente derretido por tamanho calor.\n",
							TimeUnit.MILLISECONDS, timer);
			...
			System.out.println("Sabendo que o valor de 5^7 Ã© 78,125 , qual o resultado de 5^8?");
			...
			case "B":
				...
				if (correct3.equals(Quest3[urn.get(Count[1])])) {
					...
					write("Aelin sopra uma espÃ©cie de fumaÃ§a, quase invisÃ­vel e "
							+ "consegue enganhar os guardas, depois passa facilmente por eles. "
							+ "de fogo vai em direÃ§Ã£o ao Ghoul que vÃ£o completamente derretido por tamanho calor.\n",
							TimeUnit.MILLISECONDS, timer);
		...
		if (a == 0) {
			...
			case "A":
				...
				if (correct1.equals(Quest1[urn.get(Count[0])])) {
					...
					write("Aelin cobre suas mãos de fogo e toca nas cordas que se desfazem facilmente, porem acaba queimado por não conseguir controlar o \n"
			...
			System.out.println(
					"\nAelin: Carlos e Pedro são alunos muito aplicados em matematica. Certo dia, Carlos perguntou "
							+ "a Pedro se ele sabia resolver a seguinte questão: Determine o algarismo das unidades do numero (8325474)^(642). "
	...
	public static int question7(int health, String itemGained) throws InterruptedException {
		...
		if (a == 0) {
			...
			String Quest2[] = { "470", "NÃ£o existe resposta", "4700", "490", "Nenhuma das alternativas" };
			int Count[] = { 0, 1, 2, 3, 4 };
			...
			case "A":
				...
				if (correct2.equals(Quest2[urn.get(Count[0])])) {
					...
					write("Narrador: Aelin termina a conjuração e lança a bola de fogo que acerta em cheio Takeo que não"
							+ "teve tempo de reação, dando de dano.\n", TimeUnit.MILLISECONDS, timer);
					...
					write("Narrador: Apesar da velocidade de Aelin, Takeo é mais velho e mais experiente mago, e consegue se esquivar do ataque."
							+ "Imediatamente cria uma lança de gelo e manda em direçãp a Aelin que toma : " + health
							+ " de dano.\n", TimeUnit.MILLISECONDS, timer);
		...
		if (a == 0) {
			...
			case "A":
				...
				if (correct1.equals(Quest1[urn.get(Count[0])])) {
					...
					write("\nNarrador: Uma imensa quantidade de energia se acumula nas mãos de Aelin que lança tudo em direção de Takeo, a eletricidade \n"
							+ "não da chance de reação a ele e o atinge em grande velocidade de dano.\n",
							TimeUnit.MILLISECONDS, timer);
					...
					write("\nNarrador: Uma imensa quantidade de energia se acumula nas mÃ£os de Aelin que lança tudo em direção de Takeo, oque ele \n"
							+ "não sabia é que Takeo tambem tinha conjurado uma magia, neste caso utilizou uma magia que tem a capacidade de refletir \n"
			...
			case "A":
				...
				if (correct2.equals(Quest2[urn.get(Count[0])])) {
					...
					write("\nNarrador: Uma imensa quantidade de energia se acumula nas mãos de Aelin que lança tudo em direção de Takeo, a eletricidade \n"
							+ "não da chance de reação a ele e o atinge em grande velocidade dando  de dano.\n",
							TimeUnit.MILLISECONDS, timer);
			...
			System.out.println("Aelin: Reduza para uma potencia sÃ³ 3^0 x 3^0 :\n");
			...
			case "A":
				...
				if (correct3.equals(Quest3[urn.get(Count[0])])) {
					...
					write("\nNarrador: Uma imensa quantidade de energia se acumula nas mãos de Aelin que lanÃ§a tudo em direçãpo de Takeo, a eletricidade \n"
							+ "não da chance de reação a ele e o atinge em grande velocidade dando de dano.\n",
							TimeUnit.MILLISECONDS, timer);
					...
					write("\nNarrador: Uma imensa quantidade de energia se acumula nas mãos de Aelin que lança tudo em direção de Takeo, o que ele \n"
							+ "não sabia é que Takeo tambem tinha conjurado uma magia, neste caso utilizou uma magia que tem a capacidade de refletir \n"
							+ "a magia recebida e envia-la devolta, na mesma impressionante velocidade volta e atinge Aelin em cheio tomando \n"
							+ health + " de dano.\n", TimeUnit.MILLISECONDS, timer);
	...
	public static int question9(int health, String itemGained) throws InterruptedException {
		...
		if (a == 0) {
			...
			case "A":
				...
				if (correct1.equals(Quest1[urn.get(Count[0])])) {
					...
					write("\nNarrador: Aelin conhece bem o feitiço, afinal é o seu trunfo. Apesar da dificuldade ele consegue controlar a luz que tem \n"
							+ "essa grande energia, ao finalizar, lanÃ§a em direção ao Takeo que simplesmente desaparece diante do imenso poder, \n"
					...
					write("Narrador: Aelin treinou muito esse feitiço, mas a quantidade de poder é indescritÃ­vel e muito dificil de controlar, \n"
			...
			System.out.println("\nAelin: Reduza para uma potencia sÃ³ 4 x 4 x 4: \n");
			...
			case "A":
				...
				if (correct2.equals(Quest2[urn.get(Count[0])])) {
					...
					write("\nNarrador: Aelin conhece bem o feitiÇO, afinal é o seu trunfo. Apesar da dificuldade ele consegue controlar a luz que tem \n"
							+ "essa grande energia, ao finalizar, lança direção ao Takeo que simplesmente desaparece diante do imenso poder, \n"
							+ "sobrando apenas suas cinzas....\n", TimeUnit.MILLISECONDS, timer);
					...
					write("Narrador: Aelin treinou muito esse feitiço, mas a quantidade de poder wesley indescritivel muito difÃ­cil de controlar, \n"
							+ "ele perde o controle da luz que se expande para todos os lados e da " + health
							+ "\n de dano nele e tambem acerta Takeo que simplesmente desaparece diante do imenso poder \n"
							+ "sobrando apenas suas cinzas.... \n", TimeUnit.MILLISECONDS, timer);
			...
			case "A":
				...
				if (correct3.equals(Quest3[urn.get(Count[0])])) {
					...
					write("\nNarrador: Aelin conhece bem o feitiço, afinal e o seu trunfo. Apesar da dificuldade ele consegue controlar a luz que tem \n"
							+ "essa grande energia, ao finalizar, lança em direçãoo ao Takeo que simplesmente desaparece diante do imenso poder, \n"
							+ "sobrando apenas suas cinzas....\n", TimeUnit.MILLISECONDS, timer);
					...
					write("Narrador: Aelin treinou muito esse feitiço, mas a quantidade de poder  indescritivel e muito dificil de controlar, \n"
							+ "ele perde o controle da luz que se expande para todos os lados e da " + health
							+ "\n de dano nele e tambem acerta Takeo que simplesmente desaparece diante do imenso poder \n"
							+ "sobrando apenas suas cinzas.... \n", TimeUnit.MILLISECONDS, timer);
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String[] itemName = { "um pão elfico", "uma possão de vida", "uma tunica de mithril",
				"um grimório do conhecimento", "a bota do sagaz", "o rosário do imortal", "o cajado da destruição",
				"o anel de familia" };
		...
		// variavelde alteração nos status:
		...
		do {
			...
			case 1:
				...
				write("\n O jogo é baseado em RPG de mesa, o mestre da mesa que chamamos de narrador \n"
						...
						+ "acertar as perguntas para ser bem sucedido nas magias que irá o lançar ou pode tomar dano\n"
			...
			case 2:
				...
				write("\nem um tempo antigo, cheio de violencia e misticismo, os grandes magos de Winterhold após dezenas de milhares de anos \n"
				...
				write("\nNarrador: O dia está amanhecendo, uma pequena névoa surge por entre as árvores cobrindo a área de floresta em volta da casa \n"
						+ "de Galandriel, em seu quarto, Aelin ronca como nunca por conta do cansaço causado pelos extensos treinos que vem tendo \n"
						+ "para garantir que consiga uma vaga entre os grandes magos de Winterhold e possivelmente, ser guardião do reino. O Silencio \n"
						+ "que era rompido apenas pelos altos roncos do nosso herói, foi quebrado quando Galandriel chegava na entrada do quarto e em \n"
						+ "alta voz bradou: \n", TimeUnit.MILLISECONDS, timer);
				...
				write("Narrador: Ao abrir os olhos, Aelin se depara com Galandriel olhando ele da entrada de seu quarto, um lugar com uma luminosidade \n"
						...
						+ "ele subtraiu muito tempo de sua vida folheando. O local estÃ¡ um pouco bagunçado com pratos, canecas sujas e folhas de pergaminhos \n"
				...
				write("Galandriel: o máximo que posso fazer por você, sabe bem que eu não posso interferir em mais nada em relacão ao seu treino, ou você \n"
						+ "pode acabar sendo punido com o cancelamento dos seus testes... \n", TimeUnit.MILLISECONDS,
						timer);

				System.out.println(" ");

				write("Narrador: Enquanto Galandriel se retira, Aelin se levanta e segue para fazer suas necessidades matinais. Após termina-lás, pega o seu \n"
						...
						+ "o local de treino para continuar sua preparação. Chegando no lugar ele organiza as magias que ele selecionou e começa a proferir \n"
						+ "palavas em élfico antigo: (Lembre-se que enquando o Aelin estiver conjurando, sería necessário que as questões matemáticas sejam \n"
				...
				if (maxHealth == 0) {
					...
					write("Narrador: A visão de Aelin fica escurecida e não consegue mais se mexer, aos poucos a vida se esvai"
							+ "e nada mais importa....\n", TimeUnit.MILLISECONDS, timer);
					write("Game Over !\n", TimeUnit.MILLISECONDS, timer);
				...
				write("Narrador: Apos o lancamento do feitiço, Aelin olha em sua lista o próximo e "
						+ "inicia a conjuracão: \n", TimeUnit.MILLISECONDS, timer);
				...
				write("\n Líder da Guarda Real: Bem... Provavelmente você deve saber oque houve, mas a "
						...
						+ "conseguir tirar de você onde a princesa estão, não importam os meios.\n",
						TimeUnit.MILLISECONDS, timer);
				...
				write("\nNarrador: Após alguns meses de fuga e esconderijos, Aelin finalmente chega na \n "
						...
						+ "da cidade e chega em frente a uma pequena casa, claramente não são utilizada por nobres e \n "
						+ "estão relativamente abandonada, ele bate trás vezes na porta e após alguns segundos ela \n "
				...
				write("\nAelin: Tio.... Como é bom ver algum rosto familiar ! Estou a meses assim, me \n"
						...
						+ "rumores que ela foi levada para o norte do país, gostaria muito de encontra-los logo e \n "
						+ "limpar o meu nome.... Sei que você estão aposentado, mas não poderia me ajudar \n ? ",
						TimeUnit.MILLISECONDS, timer);
				...
				write("\nMaedhros: Aelin... Que bom te ver ! Eu nunca acreditei que isso havia sido obra \n"
						+ "sua ! Um jovem mago brilhante como vocÃª e com ambição de se tornar o Guardião nunca iría \n"
				...
				// Funções de verifição dos status dos itens simples
				...
				// Verificação do numero do item, utilizado para ajustar o diálogo
				// abaixo para o
				// item sorteado.
				num = verifyItemNum(itemGained);

				write("\nMaedhros: Aelin, Aelin ! Consegui informações úteis para você e também te trouxe \n"
				...
				write("\nAelin: Tio..... Não sei como te agradecer, não imaginei que estaria aqui neste momento....\n"
						+ "Eu estava me preparando para o teste... são queria poder cuidar do Reino e deixar minha familia orgulhosa de mim.... \n"
				...
				write("\nNarrador: Aelin segue em direçao a Kiev, a noite cai na floresta e Aelin para com a intenção de descansar\n"
				...
				write("\nAelin: Takeo ! Como você póde ? Traiu Winterhold e o Reino e seus colegas Magos, você é uma vergonha.... Chega de fugir, é meu dever \n "
				...
				if (maxHealth == 0) {
					...
					write("\nNarrador: A visÃ£o de Aelin fica escurecida e ele nÃ£o consegue mais se mexer, aos poucos a vida se\n"
							+ " esvai e nada mais importa....\n", TimeUnit.MILLISECONDS, timer);
					write("\nGame Over !\n", TimeUnit.MILLISECONDS, timer);
				...
				write("\nNarrador: ApÃ³s a troca de ataques, Aelin inicia um feitiÃ§o elï¿½trico que envolve seu corpo com eletricidade e vai crescendo enquanto \n"
				...
				write("\nNarrador: A batalha continua e Aelin não ve outra opção se não conjurar o seu feitiço mais poderoso, a última vêz, ele sabe que se \n "
						+ "falhar e não controlar corretamente, pode acabar morrendo por conta da enorme forÃ§a e energia que o feitiço pode emitir, além de \n "
				...
				write("\nNarrador:  Por estar se esgotando e não ter opções, ele inicia o feitiço e enquanto ele vai seguindo uma luz muito forte se forma em  \n"
						+ "suas mãos, é possível ver que aquela luz é como se fosse feita de algo fásico, era algo assutador e realmente poderoso, ele segue \n "
				...
				write("Lyuba: Parem Imediatamente ! é assim que vocês vão tratar a pessoa que me salvou ? Vou pedir pela cabeçsa \n"
						+ "\n " + "de vocês !\n", TimeUnit.MILLISECONDS, timer);
				...
				write("\nRei Amis IV: Aelin !!! Somos gratos a você pelo seu serviço, já solicitei aos magos que garantam sua vaga no colégio de Winterhold ! /n "
						+ "Também estou indicando você para ser um dos candidatos de á Guardião do Reino, erramos em duvidar de você e gostariamos de compensa-lo./n",
						TimeUnit.MILLISECONDS, timer);

				System.out.println("");

				write("\nAelin: Magestade.... Muito obrigado pela sua generosidade. Sempre foi meu dever defender o Reino, \n "
						+ ", nÃ£o poderia ter feito diferente.\n", TimeUnit.MILLISECONDS, timer);
